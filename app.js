...
class CartManager {
    ...
    updateTotals() {
        ...
        this.cart.tax = this.cart.subtotal * this.cart.taxRate;
    ...
    updateCartDisplay() {
        ...
        // Update totals
        document.querySelector('.subtotal-amount').textContent = `$${this.cart.subtotal.toFixed(2)}`;
        document.querySelector('.tax-amount').textContent = `$${this.cart.tax.toFixed(2)}`;
